...
public class RrServer_backup extends AbstractTask implements ITcpServer, ILifeCycle
{
...
//	private Future future;
	...
	public RrServer_backup(int ioThread, String ip, int port, ITcpServerListener listener)
	{
