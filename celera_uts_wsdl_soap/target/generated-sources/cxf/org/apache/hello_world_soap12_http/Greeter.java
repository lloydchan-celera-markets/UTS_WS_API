 ...
 * 2016-09-27T10:34:46.197+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebService(targetNamespace = "http://apache.org/hello_world_soap12_http", name = "Greeter")
@XmlSeeAlso({org.apache.hello_world_soap12_http.types.ObjectFactory.class})
public interface Greeter {
    ...
    @WebMethod
    @RequestWrapper(localName = "greetMe", targetNamespace = "http://apache.org/hello_world_soap12_http/types", className = "org.apache.hello_world_soap12_http.types.GreetMe")
    @ResponseWrapper(localName = "greetMeResponse", targetNamespace = "http://apache.org/hello_world_soap12_http/types", className = "org.apache.hello_world_soap12_http.types.GreetMeResponse")
    ...
    @WebMethod
    @Oneway
    @RequestWrapper(localName = "greetMeOneWay", targetNamespace = "http://apache.org/hello_world_soap12_http/types", className = "org.apache.hello_world_soap12_http.types.GreetMeOneWay")
