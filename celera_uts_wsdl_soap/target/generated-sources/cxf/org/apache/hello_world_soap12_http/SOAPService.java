 ...
 * 2016-09-26T15:52:52.274+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "SOAPService", 
                  wsdlLocation = "file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/hello_world_soap12.wsdl",
...
public class SOAPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/hello_world_soap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOAPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/hello_world_soap12.wsdl");
        }
        WSDL_LOCATION = url;
    }
