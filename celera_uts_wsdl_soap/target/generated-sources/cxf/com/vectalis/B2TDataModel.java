 ...
 * 2016-09-26T15:52:52.210+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "B2T_DataModel", 
                  wsdlLocation = "file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/B2T_DataModel.wsdl",
...
public class B2TDataModel extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/B2T_DataModel.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(B2TDataModel.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/workspace/3rdLib/apache-cxf-3.1.7/samples/celera_uts_wsdl_soap/src/main/resources/wsdl/B2T_DataModel.wsdl");
        }
        WSDL_LOCATION = url;
    }
