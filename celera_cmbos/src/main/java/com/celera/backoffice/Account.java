...
public class Account /* implements IMongoDocument<HedgeRepo> */
{
	...
	static
	{
		...
		map.put(o1.getCompany(), o1);
		map.put(o2.getCompany(), o2);
		map.put(o2a.getCompany(), o2a);
		map.put(o2b.getCompany(), o2b);
		map.put(o2c.getCompany(), o2c);
		map.put(o2d.getCompany(), o2d);
		map.put(o4.getCompany(), o4);
		map.put(o4a.getCompany(), o4a);
		map.put(o5.getCompany(), o5);
		map.put(o5a.getCompany(), o5a);
		map.put(o6.getCompany(), o6);
		map.put(o6a.getCompany(), o6a);
		map.put(o7.getCompany(), o7);
		map.put(o8.getCompany(), o8);
		map.put(o8a.getCompany(), o8a);
		map.put(o9.getCompany(), o9);
		map.put(o10.getCompany(), o10);
		map.put(o10a.getCompany(), o10a);
		map.put(o11.getCompany(), o11);
		map.put(o12.getCompany(), o12);
		map.put(o12a.getCompany(), o12a);
		map.put(o13.getCompany(), o13);
		map.put(o14.getCompany(), o14);
		map.put(o15.getCompany(), o15);
		map.put(o16.getCompany(), o16);
		map.put(o17.getCompany(), o17);
		map.put(o18.getCompany(), o18);
		map.put(o19.getCompany(), o19);
		map.put(o20.getCompany(), o20);
		map.put(o21.getCompany(), o21);
		map.put(o22.getCompany(), o22);
		map.put(o23.getCompany(), o23);
		map.put(o24.getCompany(), o24);
		map.put(o25.getCompany(), o25);
		map.put(o25a.getCompany(), o25a);
		map.put(o26.getCompany(), o26);
		map.put(o26a.getCompany(), o26a);
		map.put(o27.getCompany(), o27);
		map.put(o27a.getCompany(), o27a);
		map.put(o28.getCompany(), o28);
		map.put(o29.getCompany(), o29);
		map.put(o33.getCompany(), o33);
	}
...

	{
		...
		// Account o1 = new Account("CEL0001", "Nomura International PLC",
		//
		// "7th Floor, Winchester, Hiranandani Business Park, Powai, Mumbai,
		// Maharashtra 400 076, India.",
		//
		// "santosh.dange@nomura.com", "Santosh Dange");
		//
		// Account o2 = new Account("CEL0002", "Deutsche Bank AG, Deutsche Bank
		// Group, Global Market Listed Derivatives",
		//
		// "Velankani Tech Park, No 43, 3rd Floor, Block 5, Electronic City,
		// Phase 1, Hosur Road, Bangalore, 560100, India",
		//
		// "futures.brokerage@db.com,singh.gagandeep@db.com,mohan.raj-mc@db.com",
		// "Futures Brokerage");
		//
		// Account o3 = new Account("", "Deutsche Bank AG, Acting Through Its
		// London Branch",
		//
		// "DBOI Global Services Private Limited, Velankani Tech Park, No 43,
		...
		// Account o4 = new Account("CEL0003", "Optiver Australia Pty Limited",
		//
		// "39 Hunter St., Sydney NSW 2000, Australia.",
		// "MiddleOfficeTeam@Optiver.com.au", "Brian Taylor");
		//
		// Account o5 = new Account("CEL0004", "Vivienne Court Trading Pty
		// Limited",
		//
		// "Suite 304, 24-30 Springfield Avenue Potts Point, Sydney, NSW 2011,
		// Australia",
		//
		// "midoffice@vivcourt.com", "Helen Robertson");
		//
		// Account o6 = new Account("CEL0005", "Liquid Capital Australia Pty
		// Limited", "United Kindom",
		//
		// "brokerage@liquidcapital.com", "Robert Wickham");
		//
		// Account o7 = new Account("CEL0006", "J.P. Morgan Securities PLC",
		//
		// "Futures & Options House Reconcillations, One@Changi City 7th Floor,
		// 1 Changi Business Park Central 1, Singapore, 486036",
		//
		// "edg_asia_index_flow_trader_confos@jpmorgan.com ,
		// brokerage.control@jpmorgan.com", "F & O House team");
		//
		// Account o8 = new Account("CEL0007", "UBS Limited", "1 Broadgate,
		// London, ECEM 2BS, United Kingdom",
		//
		// "SH-UBS-invoices@ubs.com", "SH-UBS-invoices@ubs.com");
		//
		// Account o9 = new Account("CEL0008", "Eclipse Futures (HK) Limited",
		//
		// "Room 3001, 30/F Subi Okaza, 225-257 Gloucester Road, Causeway Bay,
		// Hong Kong",
		//
		// "kechan@eclipseoptions.com, invoices@eclipseoptions.com,
		// accounts@eclipseoptions.com", "Kelvin Chan");
		//
		// Account o10 = new Account("CEL0009", "Citigroup Global Markets
		// Limited",
		//
		// "ICG Global Expense Management Team, Citigroup Centre 1, 5th Floor,
		...
		// "Mark Nunns");
		//
		// Account o12 = new Account("CEL0011", "Korea Investment & Securities
		// Co. Ltd.",
		//
		// "19/F, Trading Center, 27-1, Yeouido-dong, Yeongdeungpo-gu, Seoul,
		// -150-747, Korea",
		//
		// "Trading_op@truefriend.com, onlyone@truefriend.com", "Hanna Kim");
		//
		// Account o13 = new Account("CEL0012", "Liquid Capital Hong Kong
		// Limited",
		//
		// "21st Floor, The Center, 99 Queens Road, Central, Hong Kong",
		// "brokerage@liquidcapital.com",
		//
		// "Anthony Webb");
		//
		// Account o14 = new Account("CEL0013", "Celera Financial Limited ",
		// "11G, 51 Man Yue Street, Hunghom, Hong Kong",
		//
		// "cflbrokerage@celera-group.com", "");
		//
		// Account o15 = new Account("CEL0014", "BNP Paribas Arbitrage S.N.C.*",
		...
		// "");
		//
		// Account o16 = new Account("CEL0015", "Morgan Stanley & Co.
		// International PLC",
		//
		// " 25 Cabot Square, Canary Wharf, London, E14 4QA",
		// "brokerage.payables@morganstanley.com", "");
		//
		// Account o17 = new Account("CEL0016", "BNP Paribas Paris", "",
		// "MARINE.MALAGNOUX@UK.BNPPARIBAS.COM ",
		//
		// "442075 959700");
		//
		// Account o18 = new Account("CEL0017", "BAFM", "",
		// "derk.chan@bfam-partners.com,BFAM-MO@bfam-partners.com", "");
		//
		// Account o19 = new Account("CEL0018", "Société Générale (HK) Limited",
		// "", "FREDERIC.OLIVE@SGCIB.COM ",
		//
		// "85221665027");
		//
		// Account o20 = new Account("CEL0019", "Mirae Asset Securities Co.
		// Ltd.", "", "wonjun.hwand@miraeasset.com ",
		//
		// "822 3774 6986");
		//
		// Account o21 = new Account("CEL0020", "HYUNDAI", "",
		// "syshin09@stockmarket.co.kr", "82261141866");
		//
		// Account o22 = new Account("CEL0021", "Barclays Bank PLC", "",
		// "gupdocs@barclayscapital.com ", "");
		//
		// Account o23 = new Account("CEL0022", "Daishin Securities Co., Ltd.",
		// "",
		//
		...
		// "0401176@hmcib.com;justisoo@hmcib.com;0800574@hmcib.com", "");
		//
		// Account o25 = new Account("CEL0024", "NH Investment & Securities Co.
		// Ltd.", "", "jackie5@nhwm.com ",
		//
		// "8227687681");
		//
		// Account o26 = new Account("CEL0025", "Yuanta Securities Korea Co.,
		// Ltd.", "", "kyojin.ku@yuantakorea.com ",
		//
		// "82237705984");
		//
		// Account o27 = new Account("CEL0026", "Samsung Securities Co., Ltd.",
		// "", "youngja.yoon@samsung.com",
		//
		// "82220208426");
		//
		// Account o28 = new Account("CEL0027", "IBK Securities Co. Ltd.", "",
		// "twklem@ibks.com ", "82269155823");
		//
		// Account o29 = new Account("CEL0028", "Shinhan Investment Corp.", "",
		// "global_fo@shinhan.com", "82837722249");
